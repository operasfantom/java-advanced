...
build_classes:
	...
	javac -d out/production/implementor -p java-advanced-2019/artifacts/info.kgeorgiy.java.advanced.implementor.jar;java-advanced-2019/artifacts/info.kgeorgiy.java.advanced.base.jar;java-advanced-2019/lib src/modules/ru.ifmo.rain.yatcheniy.implementor/module-info.java
