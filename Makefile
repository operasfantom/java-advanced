...
define run_test_with_module
	java -p out/artifacts/ru_ifmo_rain_yatcheniy_$(1)_jar/ru.ifmo.rain.yatcheniy.$(1).jar;${ARTIFACTS_PATH}/info.kgeorgiy.java.advanced.$(1).jar;${ARTIFACTS_PATH}/info.kgeorgiy.java.advanced.base.jar;${LIB_PATH} --add-modules ru.ifmo.rain.yatcheniy.$(1) -m info.kgeorgiy.java.advanced.$(1) $(2) ru.ifmo.rain.yatcheniy.$(1).$(3)
endef
#01
test_walk:
...
build_classes:
	javac -encoding UTF8 -d out/production/ru.ifmo.rain.yatcheniy.implementor -p ${INFO_IMPLEMENTOR_MODULE_PATH} src/modules/ru.ifmo.rain.yatcheniy.implementor/src/ru/ifmo/rain/yatcheniy/implementor/*.java
